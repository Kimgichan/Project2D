...
public class SkillData : ScriptableObject
{
    ...
    [TextArea][SerializeField] string content = "(지우고 다시 작성해주세요) /ex> 이 스킬은 {0} ~ {1}의 데미지를 준다. / Help> needSP는 필요 SP, nums는 사용되는 {n} 변수 즉, {0}~{n}의 변수까지 사용 가능하다. 변수는 모든 정수(int), Feature의 갯수가 이 스킬의 Max Level이다. 스킬이 패시브가 아닐 경우 nums의 마지막 인덱스는 쿨타임이다.";
